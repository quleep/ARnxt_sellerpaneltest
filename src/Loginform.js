...
const RegisterForm = ({ states, cities }) => {
  ...
  const sendotpurl =
    "https://ymxx21tb7l.execute-api.ap-south-1.amazonaws.com/production/sendotpregistration";
  const verifyotpurl =
    ...
    <div>
      ...
      <form onSubmit={handleRegistraion} className="registermainform">
        ...
        <InputField
          ...
          id="Assisted By"
          name="assistedby"
          value={registrationData.assistedby}
          onChange={handleInputChange}
        />
      ...
      <form className="otpform">
        <InputField
          ...
          id="otp"
          name="otp"
          onChange={(e) => setFromOtp(e.target.value)}
        />
        <p
          style={
            disabledbutton
