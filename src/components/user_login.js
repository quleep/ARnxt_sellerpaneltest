...
class User_Login extends Component {
    ...
    SubmitHandle = (e) => {
        e.preventDefault();
        axios.post(`${url}/user/login`, this.state).then(resp => {
            if (resp.data.status) {
        ...
        return (
            ...
            <div className="container Login__container">
                ...
                <form className="form" onSubmit={this.SubmitHandle}>
                        ...
                        {errorEmail.length > 0 && <div className="errorEmail">{errorEmail}</div>}
                        ...
                        {errorPassword.length > 0 && <div className="errorPass">{errorPassword}</div>}

                        <div className='checkboxDiv'>
                            <input className="checkbox" id='showp' type="checkbox" onClick={this.show} />
                            <label className="showPass" for="showp">Show Password</label>
                        </div>
                        ...
                        <div className="notReg">
                            Not registered now ?
                            <Link className="notReg__link" to="/user_register"> Register</Link>
                        </div>
