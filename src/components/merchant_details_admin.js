...
class Merchant_Details extends Component {
          ...
          if (resp.data.admin) {
            ...
            try {
              const response = await axios.get(
                `${url}/admin/merchant_details/${merchantId}`
              );
  ...
  render() {
    const { user, admin, merchantInfo, subscribed, planDetails, planDetect } =
      this.state;
    if (typeof sessionStorage.getItem("token") === "string") {
            ...
            {merchantInfo ? (
              <div className="amerch__card">
                ...
                {planDetails ? (
                  ...
                  <p className="amerch__detail">
                    <strong>Plan selected:</strong> No plan choosen
                  </p>
                ) : (
                  <p className="amerch__detail">
                    <strong>Plan selected:</strong>Plan cannot be detected
                  </p>
                )}
