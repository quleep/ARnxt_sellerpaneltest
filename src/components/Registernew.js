                      ...
                      <div className="registermain">
                        <form onSubmit={submitHandler} className="registerform">
                              ...
                              <div className="assistdiv">
                                <div className="assist_label">
                                  <label
                                    ...
                                    <FaInfoCircle
                                      ...
                                      onMouseOver={displaytooptip}
                                      onMouseLeave={removetooltip}
                                    />{" "}
                                  </label>
                                  <div className="toolTipassist">
                                    <p>
                                      If assisted by sales person kindly enter
                                      sales Id
                                    </p>
                                  </div>
                                ...
                                <div className="assist_field">
                                  <input
                                    type="tel"
                                    onChange={(event) =>
                                      setAssisted(event.target.value)
                                    }
                                    id="formcheck"
                                    className="form-control"
                                    style={
                          ...
                          <div className="registerfooter">
                            <div
                              className="text-center pt-1 mb-1 pb-1"
