...
class Contact_Support extends Component {
    ...
    submitData(e)
    {
        ...
        setTimeout(() => contactAlert.classList.remove('contact__alert__comein'),2500);
    }
                    ...
                    <div className='container userContactCont'>
                        ...
                        <div className='userContactFormDiv'>
                            ...
                            <form className='userContact__form'  onSubmit={this.submitData}>
                                <input className='userContact__name' type="text" placeholder="Name"/>
                                <input className='userContact__email' type="email" placeholder="Email"/>
                                <input className='userContact__subject' type="text" placeholder="Subject"/>
                                <textarea className='userContact__message' name="" id="" cols="30" rows="10" placeholder="Message">
                                </textarea>
                                <button className='userContact__submitBtn' type='submit'>Submit</button>
                            </form>
