...
class Merchants extends Component {
    ...
    DeleteHandle = (email) => {
        ...
        axios.post(`${url}/admin/merchant_delete/${email}`).then(resp => {
            let id = merchantsList.findIndex(merchant => merchant.email === email);
            ...
            if (admin === true) {
                ...
                return (
                    <div className='container merchantsCont'>
                        ...
                        {deleteMsg.length > 0 && <p role="alert" className='merchants__alert'> {deleteMsg}</p>}

                        <h1 className='merchants__heading'>Merchants</h1>
                        {
                            merchantsList.length > 0 ? <div className="merchants">
                                {merchantsList.map(merchant => {
                                    return (
                                        ...
                                        <div className="merchant">
                                            ...
                                            <button className='merchant__deleteBtn'
                                ...
                                : <h4 className='merchant__noMerchant'>There are no merchants available</h4>
