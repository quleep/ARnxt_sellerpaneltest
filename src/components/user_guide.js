                        ...
                        <div className='userG'>
                            <aside className='userG__aside'>
                                <div className='userG__asideNav'>
                                    <a className='userG__link' href="#">Get Started</a>
                                    <a className='userG__link' href="#">General</a>
                                    <a className='userG__link' href="#">Features</a>
                                    <a className='userG__link' href="#">Credits</a>
                                </div>
                            </aside>
                            ...
                            <main className='userG__main'>
                                    ...
                                    <p className='userG__para'>Find the best match you can design your vicinity with, into multiple tests and trials options without any hustle and
charges paid. Begin with your journey with Arnxt where you yourself can build your empire with 3D Configurator,
Augmented Reality, Photorealistic Rendering and Quick and efficient services. By clicking here on the ‘Try Now’ option
you’ll be directed to the market where you can choose the textiles you want to add and with the help of camera visuals
you can know about how the particular object or textures suits your requirements.</p>
                                {/* <p className='userG__para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem facere culpa officia autem, ipsum reprehenderit! Magni aut ex perferendis? Dignissimos, saepe! Facere eum fugit officia suscipit illo quibusdam ipsam beatae.</p> */}
                                    ...
                                    <p className='userG__para'>Arnxt is here with the aim to provide you with the best market visualizations, our vision is to provide our customers with
the best innovative and easy to use technology. Here at Arnxt you can design your own world with the comfort of your
area.</p>
                

                                    <h2 className='userG__sub'>Features</h2>
                                    <p className='userG__para'>Features/It includes every and anything which would help the customer choose, customize and if not immediately
purchase then save the likely options they’d like to move with. One can not just get textiles and furniture but also options
to change their wall textures and floors.</p>
