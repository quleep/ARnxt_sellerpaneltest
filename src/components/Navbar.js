    ...
    <div>
      <div className="navbarmain">
        ...
        <ul className="hamlist" id="navmain">
          ...
          <li onMouseOver={removedropdown}>
            <a href="/arview" className="links">
              View in Room
            </a>
          </li>

          <li className="resource" onMouseOver={dropdownview}>
            <a className="links">Resources</a>{" "}
          </li>
          ...
          {typeof sessionStorage.getItem("user") === "string" ? (
            <button className="logoutnav" type="submit">
              <a
                style={{ cursor: "pointer" }}
                href="/login"
            ...
            <button className="loginnavbar" type="submit">
