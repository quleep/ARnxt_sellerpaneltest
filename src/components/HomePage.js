...
const [visible, setVisible]= useState(false);
  ...
  window.onscroll = function(){
   ...
   function scrollFun (){
   if( whydiv1 && whydiv2 && whydiv3  && document.documentElement.scrollTop > 20){
  ...
  return (
    ...
    <div class="slide">
			<img src="assets/images/simpolonew.png"  style={{width:'100%', height:'100%'}}  alt="logo" />
             ...
             <div className="backgroundgif_div">
...
/>
       ...
       <div  className= 'ardiv'>
        <div  className='ardiv_header'>
         

        </div>
        <div  className='ardiv_content'>
          <h3 className="" style={{marginTop:'10px', fontWeight:'bold', fontFamily:'Manrope, san-serif'}}>The future of shopping is Connected, Virtual & Augmented.</h3>
        </div>
   ...
   <span  style={{"--i":'9'}}>?</span>
                ...
                <h4 className="" style={{fontFamily:'Josefin Sans, san-serif', fontWeight:'bold'}}>Rich interactivity</h4>

              </div>
              <div className="image_divcontent3">
                <p  className="" style={{textAlign:'justify',fontFamily:'Josefin Sans, san-serif', fontWeight:'bold',fontSize:'20px'}}>
                Supports feature animations, sound, hotspots, dynamic lighting, feature-focus cameras and more.
                </p>
               ...
               <div>
                <div className="armobdiv2">
                  ...
                  <div  className="arimagedivcontent2">
                      <h4 className="" style={{marginBottom:'30px',fontFamily:'Josefin Sans, san-serif', fontWeight:'bold'}}>
                        Augmented Reality
                      </h4>

                      <p  className="" style={{textAlign:'justify', fontFamily:'Josefin Sans, san-serif', fontWeight:'bold',fontSize:'20px'}}>
                      Visualize how products will look and how well they will fit in your home or office environment.
                      </p>
               ...
               <div>
                <div className="armobdiv3">
                  ...
                  <div  className="armobdiv2footer">
                  <div  className="arimagedivcontent2">
                      <h4 className="" style={{marginBottom:'20px', fontFamily:'Josefin Sans, san-serif', fontWeight: 'bold'}}>
                        Analytics
                      </h4>

                      <p  className="analyticsp" style={{textAlign:'justify', fontFamily:'Josefin Sans, san-serif', fontWeight:'bold', fontSize:'20px'}}>
                      Get insights on which product features influence purchase decisions through in-depth experience analytics.
                      </p>
   ...
   <span  style={{"--i":'1'}}>W</span>
   <span style={{"--i":'2'}}>h</span>
   <span style={{"--i":'3', marginRight:'10px'}}>y</span>
   <span  style={{"--i":'4'}}>A</span>
   <span style={{"--i":'5'}}>R</span>
   ...
   <span  style={{"--i":'14'}}>d</span>
              ...
              <div className="getstartedcontent1" >
                ...
                <div  className="getstartedcontentbody" >
                  <div style={{display:'flex', flexDirection:'column', marginTop:'10px'}}>
                    <p className="" style={{fontSize:'20px', fontWeight:'bold', fontFamily:''}}>Simple Registration</p>
                    <p className="" style={{fontSize:'15px', fontWeight:'bold', fontFamily:'Manrope, san-serif'}}>No credit card required.</p>
              ...
              <div className="getstartedcontent1" >
                ...
                <div  className="getstartedcontentbody" >
                  <div className="logincard">
                    <p className="" style={{ fontSize:'20px',fontWeight:'bold',fontFamily:'', marginTop:'-5px', marginBottom:'20px'}}>Quick Login</p>
                    <p className="" style={{fontFamily:'Josefin Sans, san-serif',fontSize:'15px', marginTop:'-10px', fontFamily:'Manrope, san-serif',
                     fontWeight:'bold'}}>Get access to your dashboard on login.</p>
            ...
            <div className="getstartedcontent2" >
                ...
                <div  className="getstartedcontentbody2" style={{marginTop:'50px'}} >
                  <div style={{display:'flex', flexDirection:'column', marginTop:'-10px'}}>
                    <p  style={{fontSize:'20px', fontWeight:'bold', marginTop:'10px'}}>Trial</p>
                
                    <p className="" style={{fontSize:'15px', marginTop:'10px',fontFamily:'Manrope, san-serif',
                    textAlign:'justify', fontWeight: 'bold'}}>
                      Simply add details of your products and get all the premium features for them as per t&c. Have any query?
                    </p>
          ...
          />   <FaPhone/>
            ...
            <div className="getstartedcontent2" >
                ...
                <div  className="getstartedcontentbody2"  style={{marginTop:'70px', marginBottom:'120px'}}>
                  <div style={{display:'flex', flexDirection:'column', marginTop:'10px'}}>
                  <p  style={{fontFamily:'', fontWeight:'bold', fontSize:'20px'}}>Upgrade</p>
                    <p className="" style={{fontSize:'15px', textAlign:"justify", fontWeight:'bold',fontFamily:'Manrope, san-serif'
                ...
                <div  className="getstartedcontentfooter2"  style={{marginTop:'-120px', marginLeft:'10px'}}>
                <a className="checkoutplan" href='/price' >Checkout plans <FaArrowRight/></a>
            ...
            <div className="getstartedcontent2" >
                ...
                <div  className="getstartedcontentbody2"  style={{marginTop:'40px'}}>
                  <div style={{display:'flex', flexDirection:'column', marginTop:'25px'}}>
                    <p className="" style={{marginTop:'', fontWeight:'bold',fontFamily:'', fontSize:"20px"}}>Pay</p>
                    <p className="" style={{fontSize:'15px', textAlign:"justify", fontWeight:'bold',fontFamily:'Manrope, san-serif'}}>
                    We support almost all the payment methods including Credit Cards, Net Banking, UPI and others.
                    </p>
                  ...
                  <a    href="https://mail.google.com/mail/?view=cm&fs=1&to=care@arnxt.com&su=&body=&bcc="> Reach out <FaArrowRight/> </a>
   ...
   <span  style={{"--i":'12'}}>g</span>
                ...
                <div className="slider-container">
                  <div  className="brands_div">
                    <div>
                     <div  className="brands_divcontent">
                       <div className="brands_divcontent1" >
                        <h2 id= 'nbr' className="number_div">28</h2>

                       </div>
                       <div className="brands_divcontent2" >
                        <h2 className="text" style={{fontFamily:'Manrope, san-serif', fontSize:'50px', fontWeight:'bold'}}>BRANDS</h2>
                    ...
                    <div  className="brands_divcontent">
                       <div className="brands_divcontent1" >
                        <h2 id= 'nbr1' className="number_div" >8</h2>

                       </div>
                       <div className="brands_divcontent2" >
                        <h2 className="text" style={{fontFamily:'Manrope, san-serif', fontSize:'50px', fontWeight:'bold'}}>CATEGORIES</h2>
                    ...
                    <div  className="brands_divcontent">
                       <div className="brands_divcontent1" >
                        ...
                        <h2 id='nbr2' className="number_div" >100  </h2> <span className="number_div" style={{marginTop:'-7px'}}>+</span>
                       ...
                       <div className="brands_divcontent2" >
                        <h2 className="text" style={{fontFamily:'Manrope, san-serif', fontSize:'50px', fontWeight:'bold'}}>DOWNLOADS</h2>
                    ...
                    <div  className="brands_divcontent">
                       ...
                       <div className="brands_divcontent2" >
                        <h2 className="text" style={{fontFamily:'Manrope, san-serif',fontSize:'50px', fontWeight:'bold'}} >RATINGS</h2>
      ...
      <div className="cards-2 bg-gray"  style={{backgroundColor:'white', marginTop:'-200px'}}>
        ...
        <div className="container">
          ...
          <div className="">
            <div className="col-lg-12"  style={{marginBottom:'60px', marginTop:'-50px'}}>
