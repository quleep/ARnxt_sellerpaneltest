...
class Merchant_Register extends Component {
    ...
    SubmitHandle = (e) => {
        e.preventDefault();
        axios.post(`${url}/user/register`, this.state).then(resp => {
            if (resp.data.status) {
    ...
    render() {
        ...
        if (typeof sessionStorage.getItem('token') === "string" && user === false && subscribed === true) {
            return (
                <Redirect to="/models" />
            )
        }
        if (typeof sessionStorage.getItem('token') === "string" && user === false && subscribed === null) {
            return (
                <Redirect to="/plans" />
            )
        }
                ...
                <div className='regFormDiv'>
                    ...
                    <form className='regForm' onSubmit={this.SubmitHandle}>
                        ...
                        <div className='regInputDiv'>
                            ...
                            {errorName.length > 0 && <div className="regError">{errorName}</div>}
                            ...
                            {errorEmail.length > 0 && <div className="regError">{errorEmail}</div>}
                            ...
                            { errorPhone.length > 0 && <div className="regError">{errorPhone}</div>}
                            ...
                            {errorPassword.length > 0 && <div className="regError"> {errorPassword}</div>}

                            
                            <div className='regCheckboxDiv'>
                                <input className='regCheckbox' type="checkbox" id='checkbox' onClick={this.show}/>
                                <label className='regShowPass' for="checkbox">Show Password</label>
                            </div>
                            ...
                            { errorCPassword.length > 0 && <div className="regError">{errorCPassword}</div>}


                            <button className="regSubmitBtn" type="submit">Register</button>
