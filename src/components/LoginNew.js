...
const loginUrl =
  "https://4xuh6eqvr6.execute-api.ap-south-1.amazonaws.com/production/login";
            ...
            <div className="card5 rounded-3 text-black">
              <div className="logincontainer">
                    ...
                    <form onSubmit={submitHandler}>
                      ...
                      <div className="form-outline mb-4">
                        <div className="labellogin1">
                          <label className="form_label " for="form2Example11">
                            Email Id
                          </label>
                        </div>
                      ...
                      <div className="form-outline mb-4">
                        <div className="labellogin2">
                          <label className="form_label" for="form2Example22">
                            Password
                          </label>
                        </div>
                ...
                <div
                  ...
                  style={{ height: "660px", marginTop: "-60px" }}>
                  <div className="imagelogin">
                    <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                      ...
                      <p
                        ...
                        Partner with us to build an experiential marketplace for
                        your customers.
                      </p>
                    </div>
                  </div>
