...
const ARdetails = () => {
  ...
  useEffect(() => {
    axios
      .post(itemdetails, location.state.id)
      .then((res) => {
        setGlbUrl(res.data);
      })
      .catch((error) => {
        ...
        <div className="arviewdetailscontainer">
          ...
          <div>
            <div className="productdetailsinside">
              ...
              <p>{`${glburl && glburl.productdetails[0].lengthprod} * ${
                glburl && glburl.productdetails[0].breadthprod
              } * ${glburl && glburl.productdetails[0].height} (L*B*H) `}</p>
            </div>
          </div>
          <div>
            <div className="productdetailsinside">
