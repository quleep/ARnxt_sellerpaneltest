...
function Navbartest() {
  ...
  const drawerAnimatorUserBox = (e) => {
    let flag = document
      .getElementById("userbox__items")
      .classList.toggle("drawer-down");
    function offFocus(e) {
  ...
  const drawerAnimatorMerchBox = (e) => {
    let flag = document
      .getElementById("merchbox__items")
      .classList.toggle("drawer-down");
    function offFocus(e) {
      document
        .getElementById("merchbox__items")
        .classList.remove("drawer-down");
      window.removeEventListener("click", offFocus);
    }
    if (flag) setTimeout(() => window.addEventListener("click", offFocus), 1);
  };
  ...
  const dropDownAnimator = (e) => {
    let flag = document
      .getElementById("dropDownNav")
      .classList.toggle("dropDownNavToggleAni");
    function offFocus(e) {
      document
        .getElementById("dropDownNav")
        .classList.remove("dropDownNavToggleAni");
      window.removeEventListener("click", offFocus);
    }
    if (flag) setTimeout(() => window.addEventListener("click", offFocus), 1);
  };
  ...
  return (
    <div className="" style={{ backgroundColor: "" }}>
      <div>
        <nav
          id="navbarExample"
          className="navbar navbar-expand-lg  navbar-toggleable-md fixed-top navbar-dark py-3"
          aria-label="Main navigation">
          <div className="container-fluid">
            <Link className="navbar-brand logo-text" to="/">
              ...
              <img
                className="imgfluid"
                src="assets/images/arnxtreg.png"
                alt="alternative"
              />{" "}
            </Link>
            ...
            <button
              ...
              <span
                ...
                className=" my-1 mx-2 close  "
                style={navi ? { display: "block" } : { display: "none" }}>
                X
              </span>
              <span
                id="navbaropen"
                ...
                style={
                  navi ? { display: "none" } : { display: "block" }
                }></span>
            </button>
