...
const InputField = ({ label, type, id,name, value, onChange}) => {
  ...
  const LoginForm = () => {
    ...
    const loginUrl= 'https://ymxx21tb7l.execute-api.ap-south-1.amazonaws.com/production/loginvisualiserclient'
      ...
      return (
        ...
        <div>
          ...
          <InputField label="UserId" type="email" id="email" name = 'email' value={loginarray.email} onChange={handleInputChange} />
