...
<p className="card-text">Retailers are instead turning to AR to help customers digitally test out thousands of beauty .......</p>
...
<div className="card-body1">
  ...
  <div className='cardtext'>
<p className="card-text">Augmented reality stating the technology as differentiator,  towards Retail........</p>
...
<div className="card-body1">
  ...
  <div className='cardtext'>
<p className="card-text">  Augmented reality in our surroundings. To have a better understanding of this  .....</p>
