      ...
      <div className="mainbodyhomepage">
        <div className="sectiononehome">
          <div className="sectiononehomeinside">
            <div className="sectiononehomeheading">
              <h1>
                Step into a new age of product <h2>visualisation </h2>with{" "}
                <h2>ArNXT</h2>
              </h1>
              <p>
                ArNXT is poised to transform our shopping experience, blending
                convenience, instant access, immersive and personal touch into
                one seamless mix.
              </p>
        ...
        <div className="sectiontwohome">
          <div className="sectiontwohomeinside">
            ...
            <div className="sectiontwohomeheading">
              ...
              <p>
                Imagine effortlessly visualising different wallpaper designs in
                your space before making a decision.
              </p>
              <p>Select a perfect wall design with ArNXT wall visualiser.</p>
        ...
        <div className="sectionsevenhome">
          <div className="sectionsevenhomeinside" id="sectionsevenhomeinside">
            <div className="sectionsevenhomeheading">
              <h1>
                Watch your <h2> business </h2>grow with <h2>ArNXT</h2>
              </h1>
            </div>
        ...
        <div className="sectionthreehome">
          <div className="sectionthreehomeinside">
            <div className="sectionthreehomeheading" id="section3divheading">
              <h1>
                <h2>Flooring</h2> Redefined: See Try Transform
              </h1>
              <p>
                Picture trying out different flooring styles without lifting a
                tile. Visualise, experiment, and experience different floor
                aesthetics.
              </p>
            ...
            <div
              className="sectionthreehomegifcontainer"
              id="section3imagecontainer">
        ...
        <div className="sectionfourhome">
          <div className="sectionfourhomeinside">
            <div
              className="sectionfourhomegifcontainer"
              id="section4imagecontainer">
            ...
            <div className="sectionfourhomeheading" id="section4divheading">
              ...
              <p>
                Immerse yourself in the joy of visualising, customising, and
                experiencing varied upholstery styles within your home's
                comfort.
              </p>
              <p>Select a perfect fabric with ArNXT upholstery.</p>
          ...
          <div className="sectionsixhomeinside">
            <div className="sectionsixhomeheading">
              ...
              <ul>
                <li>
                  {" "}
                  <h4>One stop solution for all visualisation</h4>
                </li>
                <p>One platform for the brands, products and users</p>
                <li>
                  {" "}
                  <h4>Seamless Multi-Channel Integration</h4>
                </li>
                <p>
                  A 2 step solution to Blend ArNXT into your existing tech stack
                </p>
                <li>
                  {" "}
                  <h4>Sales enabling tool</h4>
                </li>
                <p>
                  A catalyst for driving revenue generation and enhancing
        ...
        <div className="sectionfivehome">
          <div className="sectionfivehomeinside">
            <div className="sectionfivehomeheading">
              <h1>
                ArNXT is <p>trusted</p> by world <p>leaders</p>
              </h1>
            </div>
