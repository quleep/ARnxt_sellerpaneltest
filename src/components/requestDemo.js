...
class Request_Demo extends Component {
  ...
  submitData(e) {
    ...
    setTimeout(
      () => requestAlert.classList.remove("request__alert__comein"),
      2500
    );
  }
        ...
        <div className="container requestDemoCont">
          <div className="requestDemoFormDiv">
            ...
            <form className="requestDemo__form" onSubmit={this.submitData}>
              <input
                className="requestDemo__name"
                type="text"
                placeholder="Name"
              />
              <input
                className="requestDemo__email"
                type="email"
                placeholder="Email"
              />
              <input
                className="requestDemo__subject"
                type="text"
                placeholder="Subject"
              />
              <textarea
                className="requestDemo__message"
                name=""
                id=""
                cols="30"
                rows="10"
                placeholder="Message"></textarea>
              <button className="requestDemo__submitBtn" type="submit">
                Submit
              </button>
            </form>
