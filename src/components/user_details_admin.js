            ...
            axios.get(`${url}/merchant/profile/${token}`).then(resp => {
                if (resp.data.user) {
                    ...
                    if (resp.data.admin) {
                        ...
                        axios.get(`${url}/admin/user_details/${userId}`)
                            .then(response => {
                                this.setState({
                                    admin: true,
                    ...
                    <div className='container aUserCont'>
                        {userInfo 
                            ...
                            <div className='aUser__card'>
                                ...
                                <p className='aUser__detail'><strong>Name : </strong>{userInfo.name}</p>

                                <p className='aUser__detail'><strong>Email : </strong>{userInfo.email}</p>

                                <p className='aUser__detail'><strong>Phone : </strong>{userInfo.phone}</p>
