...
class Users extends Component {
    ...
    DeleteHandle = (email) => {
        ...
        axios.post(`${url}/admin/user_delete/${email}`).then(resp => {
            ...
            if (admin === true) {
                return (
                    <div className='container usersCont'>
                        ...
                        {deleteMsg.length > 0 && <h2 className='users__alert'>{deleteMsg}</h2>}
                        
                        <h1 className='users__heading'>Users</h1>

                        {
                            usersList.length > 0 ? <div className="users">
                                {
                                    usersList.map(user => {
                                        return (
                                                <div className='user'>
                                                    ...
                                                    <button className='user__deleteBtn'
