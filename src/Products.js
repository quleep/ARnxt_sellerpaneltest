...
const Products = ({ history }) => {
  ...
  const registerUrl =
    "https://7ufiupng0k.execute-api.ap-south-1.amazonaws.com/sellerupload/productsadd";
      ...
      <div className="productmain_container">
        <div>
          <div className="productheading">
            <h4 style={{ fontSize: "25px", color: "#65f7ef" }}>
              ...
              <form className="formbody" onSubmit={submitHandler}>
                <div
                  ...
                  <div className="" style={{ marginBottom: "30px" }}>
                    <div style={{ display: "flex" }}>
                      <label
                        ...
                        style={{ color: "white" }}
                        className="form-label">
                        Partner address (Pl put Area/Road name){" "}
                        <span style={{ color: "red", fontSize: "30px" }}>
                          *
                        </span>
                      </label>
                    ...
                    <textarea
                      ...
                      onChange={(event) =>
                        setMerchantAddress(event.target.value)
                      }
                      className="form-control"
                      id="inputEmail4"
                    />
                  ...
                  <div className="" style={{ marginBottom: "20px" }}>
                    <div style={{ display: "flex" }}>
                      <label
                        ...
                        style={{ color: "white" }}
                        className="form-label">
                        Dimensions(Length x Breadth x Height inches){" "}
                        <span style={{ color: "red", fontSize: "30px" }}>
                          *
                        </span>
                      </label>
                  ...
                  <div className="products_field3">
                    <div style={{ display: "flex" }}>
                      <label
                        ...
                        style={{ color: "white" }}
                        className="form-label">
                        Purchase URL (Website/Email id of partner){" "}
                        <span style={{ color: "red", fontSize: "30px" }}>
                          *
                        </span>
                      </label>
                  ...
                  <div
                    ...
                    style={imageupload ? { display: "none" } : {}}>
                    {images.map((img) => (
