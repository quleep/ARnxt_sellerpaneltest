...
const registerUrl =
  "https://4xuh6eqvr6.execute-api.ap-south-1.amazonaws.com/production/register";
const sendotpurl =
  "https://4xuh6eqvr6.execute-api.ap-south-1.amazonaws.com/production/sendotp";
const verifyotpurl =
  "https://4xuh6eqvr6.execute-api.ap-south-1.amazonaws.com/production/verifyotp";
              ...
              <form
                ...
                <div className="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
                  ...
                  <div className="card-body p-4 p-sm-5" style={{}}>
                    <h5
                      className="card-title text-center mb-5 fw-bold fs-5"
                      style={{}}>
                      Register
                    </h5>
                    ...
                    <div className="d-grid mb-2" id="phoneno_div">
                      {resend ? (
                        <button
                          ...
                          disabled={verifydisplay ? "disabled" : ""}
                          style={
                            otpshow
                              ? {
                                  width: "120px",
                      ...
                      {verifymessage && (
                        <p style={{ color: "green", marginTop: "-40px" }}>
                          Verified <FaCheck />
                        </p>
                      )}
                    </div>
                    ...
                    {otpverifymessage && (
                      <p style={{ color: "red" }}> {otpverifymessage}</p>
                    )}
                    ...
                    <div style={displaybar ? {} : { display: "none" }}>
                      <div
                        style={
                          color
                            ? { width: "140px", border: "2px solid green" }
                            : { width: "140px", border: "2px dashed red" }
                        }></div>
                    ...
                    <Link
                      className="d-block text-center mt-2 medium"
                      to="/Login">
