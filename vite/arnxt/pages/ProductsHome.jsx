  ...
  return (
    <div className="productspage">
      ...
      <Helmet>
        <title>
          {" "}
          Arnxt - Products | Augmented Reality Products for Business{" "}
        </title>
        <meta
          name="description"
        ...
        <div className="productslogo_div">
          <div>
            <div className="productscontent_div">
              <img
                src="/assets/images/consumerapplogo.png"
                alt="logo"
                onMouseOver={click1}
          ...
          <div>
            <div className="productscontent_div">
              <img
                src="/assets/images/businessapplogo.png"
                alt="logo"
                onMouseOver={click2}
                style={{ height: "50px", width: "50px" }}
              />
          ...
          <div id="div1" className="div1" style={{ display: "flex" }}>
            <div className="imagediv1">
              <div className="consumerdiv_heading">
                <h2>
                  An app which will be an experiential marketplace for your
                  products.{" "}
                </h2>
              </div>
                      ...
                      <div className="qrcodediv">
                        ...
                        <div className="qrcodedivbody">
                          <img
                            ...
                            src="/assets/images/arnxtqrcode.png"
                          />
                        </div>
                            ...
                            <div class="faq-drawer__content-wrapper">
                              <div class="faq-drawer__content">
                                <ul className="categorylist">
                                  ...
                                  <li>
                                    <p>Floor tiles for commercial spaces</p>
                                  </li>
                        ...
                        <div className="viewindivbody">
                            ...
                            <div class="faq-drawer__content-wrapper">
                              <div class="faq-drawer__content">
                                <p className="productstext">
                                  Place furniture, Appliances etc. from an large
                                  collection.
                                </p>
                              </div>
                            </div>
                          ...
                          <div class="faq-drawer">
                            ...
                            <div class="faq-drawer__content-wrapper">
                              <div class="faq-drawer__content">
                                <p className="productstext">
                                  Change position, rotation or scale of your
                                  product in realtime
                                </p>
                              </div>
                            </div>
      ...
      */}
          ...
          <div
            ...
            <div className="imagediv2" style={{}}>
              <div className="consumerdiv2_heading">
                <h2 className="business_heading">
                  Have some exclusive designs only for your clients ?
                </h2>
                <h2 className="business_heading"> OR </h2>
                <h2 className="business_heading">
                  Need white label solutions to grow your revenue ?{" "}
                </h2>
              </div>
              <div className="bussiness_container">
                <img
                  src="/assets/images/arnxtBapp.png"
                  className="bussiness_image"
                  alt="logo"
                />
                <div className="bussiness_subcontainer">
                  <div className="bussinesslogodiv">
                    <h5 className="textfeatures">For further details</h5>
                  </div>
          ...
          <div
            ...
            <div className="businessapp_headingdiv">
              <h2 className="businessapp_heading">
                Manage your products and get all the data you need to boost your
                sales
              </h2>
            </div>
                ...
                <div className="dashboardarrow_div">
                  <div
                    ...
                    <div className="arrow_proddash1">
                      ...
                      <div
                        className=""
                        style={{ border: "", width: "50px", height: "50px" }}>
                        <div className="triangle-right"></div>
                      </div>
                      <div style={{}}>
                        <h5
                          style={{ textAlign: "justify", fontWeight: "" }}
                          className="textfeatures">
                          Brand comparison
                        </h5>
                      </div>
                    </div>
