  ...
  const handlesubmitquery = async () => {
    ...
    try {
      const response = await axios.post(
        `https://ymxx21tb7l.execute-api.ap-south-1.amazonaws.com/production/addquerydata`,
        query
      );
  ...
  const handlearclick = () => {
    try {
      ...
      const response = axios.post(
        "https://ymxx21tb7l.execute-api.ap-south-1.amazonaws.com/production/addviewcountarnxt",
        body
      );
    } catch (err) {
      console.log(err);
            ...
            <div class="product_detail_ar_container_child_child">
              <div class="product_detail_ar_container_child_child_grid">
                ...
                <div class="product_detail_ar_container_grid_child1">
                  ...
                  <div className="product_detail_ar_container_grid_child1_text2">
                    <a
                      href={emailID === null ? "/login" : "#open-modalquery"}
                      className="btn-link">
                  ...
                  <div id="open-modalquery" class="modal-window">
                    <div>
                      ...
                      <p className="semibold_text">Your query</p>
                      <textarea
